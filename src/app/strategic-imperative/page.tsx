  ...
  return (
    <SubPageLayout>
      <article className="prose prose-slate dark:prose-invert lg:prose-xl max-w-none text-slate-300 space-y-6">
        ...
        <h2 className="text-3xl font-semibold text-white !mt-12 !mb-6 border-b border-slate-700 pb-2">
          1.2 Redefining PPAP: Power, Performance, Area, and <span class="gradient-text">Productivity</span>
        </h2>
        <p>The &quot;three goals of chip design&quot;—Power, Performance, and Area (PPA)—have long been the central tenets of the industry. Optimizing the trade-offs between these three variables is the core of the design process. However, the sheer complexity of sub-10nm designs and the intense pressure of shrinking market windows have elevated a fourth, equally critical dimension: <span className='gradient-text'>Productivity</span>.</p>
