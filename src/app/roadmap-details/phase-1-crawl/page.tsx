...
// src/app/roadmap-details/phase-1-crawl/page.tsx
"use client";
import React from 'react';
import SubPageLayout from '@/components/chimera/SubPageLayout';
import { Milestone, Layers3, GanttChartSquare, Users, ShieldAlert, BookOpenCheck, ServerCog, CheckSquare, GitFork, Workflow, ListChecks, Milestone as MilestoneIcon, BrainCircuit, Cpu } from 'lucide-react'; // Added more specific icons

export default function RoadmapPhase1CrawlPage() {
  return (
    <SubPageLayout backButtonHref="/roadmap-details" backButtonText="&larr; Back to Roadmap Overview">
      <article className="prose prose-slate dark:prose-invert lg:prose-xl max-w-none text-slate-300 space-y-6">
        <div className="flex flex-col items-center text-center mb-12">
          <Milestone className="h-16 w-16 text-sky-400 mb-4" />
          <h1 className="text-4xl md:text-5xl font-bold text-sky-400 !mb-2 md:leading-tight">
            Roadmap: Phase 1 - Crawl
          </h1>
          <p className="text-2xl text-slate-400">Foundational Infrastructure & Agentic Pilot (Q3 2025 - Q4 2026)</p>
        </div>

        <p className="italic text-center text-lg text-slate-400 !mt-0">Project Chimera: An Actionable Implementation Plan for Phase 1</p>
        
        <div className="mt-8 mb-4 flex items-center">
          <ServerCog className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
        ...
        <div className="mt-16 mb-4 flex items-center">
          <Layers3 className="h-8 w-8 text-sky-400 mr-4 flex-shrink-0" />
          <h2 className="text-3xl font-semibold text-sky-400 !m-0 !border-b-0 !pb-0">
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">1.1. Phase 1 Objectives, Scope, and Mandate</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">1.2. The Foundational Technology Stack: MCP Server, LangGraph, and LangSmith</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">1.3. Defining and Measuring Success: Phase 1 Key Performance Indicators (KPIs)</h3>
        </div>
        ...
        <div className="mt-16 mb-4 flex items-center">
          <GanttChartSquare className="h-8 w-8 text-sky-400 mr-4 flex-shrink-0" />
          <h2 className="text-3xl font-semibold text-sky-400 !m-0 !border-b-0 !pb-0">
        ...
        <div className="mt-8 mb-4 flex items-center">
          <MilestoneIcon className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">2.1. Detailed Quarter-by-Quarter Project Timeline (Q3 2025 – Q4 2026)</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          <CheckSquare className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">2.2. Critical Milestones and Governance Checkpoints</h3>
        </div>
        <ul className="list-disc pl-5 space-y-1 mt-1">
        ...
        <div className="mt-8 mb-4 flex items-center">
            ...
            <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">Table: Phase 1 Detailed Project Gantt Chart</h3>
        </div>
        ...
        <div className="overflow-x-auto my-6">
            ...
            <tbody className="divide-y divide-slate-700 bg-slate-800/30">
                ...
                <tr><td className="px-2 py-1">1.1</td><td className="px-2 py-1">Form Governance & Project Teams</td><td className="px-2 py-1">-</td><td className="px-2 py-1">Project Lead</td><td className="px-2 py-1">Q3-W1 25</td><td className="px-2 py-1">Q3-W4 25</td><td className="px-2 py-1">-</td><td className="px-2 py-1">Complete</td><td className="px-2 py-1">Project Charter</td></tr>
                ...
                <tr><td className="px-2 py-1">3.0</td><td className="px-2 py-1">Pilot Project: Agentic TDD</td><td className="px-2 py-1">-</td><td className="px-2 py-1">RTL Pilot Lead</td><td className="px-2 py-1">Q1-W1 26</td><td className="px-2 py-1">Q3-W13 26</td><td className="px-2 py-1">-</td><td className="px-2 py-1">-</td><td className="px-2 py-1">-</td></tr>
        ...
        <div className="mt-16 mb-4 flex items-center">
            <Users className="h-8 w-8 text-sky-400 mr-4 flex-shrink-0" />
            <h2 className="text-3xl font-semibold text-sky-400 !m-0 !border-b-0 !pb-0">
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">3.1. A Proposed Governance Model for Project Chimera</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          <GitFork className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">3.2. MLOps and Observability: The CI/CD and Evaluation Framework for Agentic Systems</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">3.3. Discipline-Specific Execution Plan for the RTL TDD Pilot</h3>
        </div>
        ...
        <div className="mt-16 mb-4 flex items-center">
            <ShieldAlert className="h-8 w-8 text-sky-400 mr-4 flex-shrink-0" />
            <h2 className="text-3xl font-semibold text-sky-400 !m-0 !border-b-0 !pb-0">
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">4.1. Mitigating Technical Risks: A Focus on Reliability and Interpretability</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          <GitFork className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">4.2. Mitigating Performance and Complexity Risks in a Supervisor-Worker Architecture</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">4.3. A Zero-Trust Framework for Securing the MCP Server and Intellectual Property</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          ...
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">4.4. Mitigating Cultural and Adoption Risks: A Change Management Blueprint</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
            <ListChecks className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
            <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">Table: Phase 1 Risk Register</h3>
        </div>
        ...
        <div className="mt-16 mb-4 flex items-center">
            <BookOpenCheck className="h-8 w-8 text-sky-400 mr-4 flex-shrink-0" />
            <h2 className="text-3xl font-semibold text-sky-400 !m-0 !border-b-0 !pb-0">
        ...
        <div className="mt-8 mb-4 flex items-center">
          <BrainCircuit className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">5.1. Architectural Precedent: The Supervisor-Worker Model in Enterprise Production</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          <CheckSquare className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">5.2. Case Study in Focus: The Pragmatism of Agentic Test-Driven Development (TDD)</h3>
        </div>
        ...
        <div className="mt-8 mb-4 flex items-center">
          <ListChecks className="h-7 w-7 text-primary mr-3 flex-shrink-0" />
          <h3 className="text-2xl font-semibold text-primary !m-0 !border-b-0 !pb-0">5.3. Strategic Lessons from Enterprise AI Adoption Roadmaps</h3>
        </div>
        ...
        <div className="mt-16 mb-4 flex items-center">
            <MilestoneIcon className="h-8 w-8 text-sky-400 mr-4 flex-shrink-0" />
            <h2 className="text-3xl font-semibold text-sky-400 !m-0 !border-b-0 !pb-0">
