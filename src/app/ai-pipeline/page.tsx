        ...
        <div className="section-card p-6 rounded-2xl mt-12">
          ...
          <ul className="list-none pl-0 space-y-6 !my-6">
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-3">
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <Shuffle className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  <strong className="text-primary block mb-1">Automated Coverage Analysis and Closure:</strong> The <strong>AutoDV (Automatic Design Verification) Agent</strong> plays a critical role in driving coverage closure. It continuously analyzes various forms of <strong>coverage metrics</strong> (code coverage, functional coverage, assertion coverage, toggle coverage) from extensive simulation runs.
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <Filter className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
          ...
          <ul className="list-none pl-0 space-y-6 !my-6">
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <Binary className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <Puzzle className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  <strong className="text-primary block mb-1">Exhaustive Static Analysis & Linting:</strong> The <strong>AutoReview Agent</strong> continues its role from earlier stages, but now performs an <strong>exhaustive, chip-level static analysis</strong>.
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <BookOpenCheck className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
              ...
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  <strong className="text-primary block mb-1">Security Verification:</strong> A specialized sub-component of the <strong>AutoDV Agent</strong> or a dedicated <strong>Security Verification Agent</strong> actively probes the design for <strong>security vulnerabilities</strong>.
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <LockKeyhole className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <BugPlay className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <div className="section-card p-6 rounded-2xl mt-12">
          ...
          <ul className="list-none pl-0 space-y-6 !my-6">
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  <strong className="text-primary block mb-1">Automated Failure Analysis & Localization:</strong> The <strong>Debug & Root Cause Analysis Agent</strong> is the tireless problem-solver. When a simulation fails, a formal tool produces a counter-example, or a metric deviates from expectation, this agent springs into action.
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <ScrollText className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <LineChart className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                        <div><strong className="text-sky-300 block mb-1">Waveform Analysis:</strong> It integrates with <strong>waveform viewers</strong> to automatically navigate and analyze critical signal traces and timing paths identified as problematic. It can filter noise, highlight key events, and correlate activity across multiple design blocks.</div>
                      </div>
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                ...
                <div>
                  ...
                  <div className="mt-2 space-y-3">
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        ...
                        <div><strong className="text-sky-300 block mb-1">Suggest Solutions:</strong> Propose specific, actionable code modifications or design adjustments to resolve the identified bug. This feedback is directed back to the <strong>RTL Generation & Refinement Agent</strong> or the <strong>Supervisor Agent</strong>.</div>
                      </div>
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <RotateCcw className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <div className="section-card p-6 rounded-2xl mt-12">
          ...
          <ul className="list-none pl-0 space-y-6 !my-6">
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  <strong className="text-primary block mb-1">System-Level Performance Verification:</strong> A <strong>Performance Verification Agent</strong> takes the lead here.
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
              ...
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                ...
                <div>
                  <strong className="text-primary block mb-1">Power Verification & Integrity:</strong> The <strong>Power & Design Rule Check (DRC) Analysis Agent</strong> extends its role to comprehensive power verification.
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <Activity className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        ...
                        <div><strong className="text-sky-300 block mb-1">Power Integrity Analysis:</strong> It analyzes <strong>power integrity</strong> (e.g., IR drop, electromigration) using specialized tools, ensuring the power delivery network is robust across the entire chip. This analysis feeds back into the <strong>Physical Implementation Agent</strong> (Stage 10) for layout adjustments.</div>
                      </div>
                  </div>
                </div>
              </li>
              <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
                <ShieldCheck className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
                <div>
                  <strong className="text-primary block mb-1">Comprehensive Security Verification:</strong> Building on earlier formal checks, the <strong>Security Verification Agent</strong> performs holistic, chip-level security assessments. This includes:
                  <div className="mt-2 space-y-3">
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <ScanSearch className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                      ...
                      <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                        <ListChecks className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <div className="section-card p-6 rounded-2xl mt-12">
          ...
          <ul className="list-none pl-0 space-y-6 !my-6">
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <ClipboardList className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div>
                <strong className="text-primary block mb-1">Intelligent DFT Planning:</strong> A dedicated <strong>DFT Planning Agent</strong> (a new specialized Physical Design & Optimization Agent or a Specialized Analysis Agent from Section 2.2, expanding on its capabilities) analyzes the RTL or initial gate-level netlist received from previous stages.
                <div className="mt-2 space-y-3">
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <BrainCircuit className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              ...
              <div>
                <strong className="text-primary block mb-1">Automated DFT Insertion:</strong> The <strong>DFT Insertion Agent</strong> (another new specialized Physical Design & Optimization Agent) takes the DFT plan and autonomously modifies the design by inserting the necessary test logic.
                 <div className="mt-2 space-y-3">
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
            ...
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              ...
              <div>
                <strong className="text-primary block mb-1">Intelligent Test Pattern Generation (ATPG):</strong> The <strong>ATPG Agent</strong> (a specialized Physical Design & Optimization Agent or Verification Agent) is responsible for generating efficient and high-quality test patterns.
                <div className="mt-2 space-y-3">
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <Crosshair className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <ShieldCheck className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div>
                <strong className="text-primary block mb-1">DFT Verification and Validation:</strong> A <strong>DFT Verification Agent</strong> (a Verification Agent from Section 2.2) rigorously verifies the correctness of the inserted DFT logic and the generated test patterns.
                <div className="mt-2 space-y-3">
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <PlayCircle className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
        ...
        <div className="section-card p-6 rounded-2xl mt-12">
          ...
          <ul className="list-none pl-0 space-y-6 !my-6">
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <SlidersHorizontal className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div>
                <strong className="text-primary block mb-1">Intelligent PPA Optimization Orchestration:</strong> The <strong>PPA Optimization Agent</strong> is the master conductor for the entire physical design flow. It intelligently orchestrates the integrated physical design EDA toolchain (including the <strong>Synthesis Agent, Physical Implementation Agent, and Timing Closure Agent</strong> from Section 2.2, all accessed via the MCP Server&apos;s Tool Abstraction Layer). Its core intelligence lies in systematically exploring valid parameter combinations and applying known optimization strategies to converge on optimal PPA.
              </div>
            </li>
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <Target className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div>
                <strong className="text-primary block mb-1">Engineer-Driven Constraints & Goal Translation:</strong> The process begins with our human design engineers setting precise, high-level PPA goals and constraints (e.g., target clock frequency, maximum power budget, specific area footprint). The PPA Optimization Agent translates these overarching objectives into granular, actionable directives and parameter sets for the underlying EDA tools. This translation is powered by:
                <div className="mt-2 space-y-3">
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <Keyboard className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Prompt Engineering:</strong> Carefully crafted prompts guide general-purpose LLMs to reason about the complex interplay of physical design parameters, analyze intermediate results, and propose intelligent modifications.</div>
                  </div>
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <DatabaseZap className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Knowledge Hub (RAG):</strong> The agent extensively queries the Knowledge Hub (RAG) in the MCP Server, retrieving historical successful design methodologies, optimal tool parameter settings for similar blocks, past PPA trade-off analyses, and process-node specific guidelines. This provides crucial in-context learning and expert guidance.</div>
                  </div>
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <Focus className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Targeted Fine-Tuning (Optional/Limited):</strong> For highly specific and recurring optimization problems or to better interpret nuanced EDA tool logs and reports, limited, targeted fine-tuning of the underlying LLM can be applied. This focuses on narrow domain-specific understanding rather than broad model development, enhancing the agent&apos;s precision in critical optimization loops.</div>
                  </div>
                </div>
              </div>
            </li>
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <Repeat2 className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div>
                <strong className="text-primary block mb-1">Systematic Parameter Exploration & Iterative Refinement:</strong> The agent drives iterative physical design runs, applying new parameter sets and analyzing the results. The loop involves:
                <div className="mt-2 space-y-3">
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <Settings2 className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Parameter Application:</strong> The agent sends an optimized set of parameters and directives to the relevant physical design agents (Synthesis, Physical Implementation, Timing Closure).</div>
                  </div>
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <PlayCircle className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Tool Execution:</strong> The physical design agents execute the EDA tools.</div>
                  </div>
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <SearchCode className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Result Analysis:</strong> The PPA Optimization Agent meticulously analyzes the output PPA metrics (timing, power, area, congestion) and design rule violations from each run. It leverages prompt engineering and RAG to interpret complex reports and identify areas for improvement or violation.</div>
                  </div>
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <Lightbulb className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Strategic Adjustment:</strong> Based on its analysis, the agent reasons about the next optimal set of parameter adjustments to guide the design towards convergence. This involves identifying which parameters to tweak, what values to try, and which optimization strategies to prioritize, always adhering to the engineer-defined constraints.</div>
                  </div>
                  <div className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30">
                    <CheckCircle2 className="h-5 w-5 text-sky-400 mr-3 mt-0.5 flex-shrink-0" />
                    <div><strong className="text-sky-300 block mb-1">Manufacturability Integration:</strong> The agent also integrates early feedback from the Yield Prediction Agent (from Stage 3.11) on potential manufacturing hotspots or yield detractors, factoring these into its PPA optimization decisions to ensure designs are not just optimal in PPA but also highly manufacturable.</div>
                  </div>
                </div>
              </div>
            </li>
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <Inspect className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div>
                <strong className="text-primary block mb-1">Multi-Objective Evaluation & Continuous Feedback Loop:</strong> After each physical design iteration, the system performs an automated, multi-objective evaluation of the agent&apos;s current output. This evaluation is a comprehensive assessment based on:
                <ul className="list-disc pl-5 mt-1 space-y-1 text-slate-400">
                    <li>Direct PPA Metrics: Precise measurements of timing closure, dynamic and static power consumption, silicon area utilization, routing congestion, and physical design rule compliance.</li>
                    <li>Manufacturability Insights: Integration of early yield predictions. This continuous in-loop evaluation provides immediate quantitative feedback to the PPA Optimization Agent to inform its next strategic adjustment. Moreover, these evaluation results, tracked via platforms like LangSmith, contribute to the ongoing improvement of the underlying LLM prompts and the training data within the Knowledge Hub, ensuring the agent&apos;s intelligence continuously adapts and refines its optimization strategies for future designs.</li>
                </ul>
              </div>
            </li>
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <UsersRound className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div>
                <strong className="text-primary block mb-1">Deep Collaboration and Human Oversight:</strong> The PPA Optimization Agent works in tight collaboration with other agents, receiving inputs from the Timing Closure Agent to resolve critical path delays and integrating analysis from the Power & Design Rule Check (DRC) Analysis Agent (from Section 2.2) for power integrity and manufacturing compliance. The Supervisor agent (from the Central Intelligence Hub) continuously tracks the PPA Optimization Agent&apos;s progress and convergence, ensuring adherence to overall project goals. The Human-in-the-Loop Interface provides transparent dashboards displaying these real-time evaluation metrics for human experts to monitor progress, understand the AI&apos;s reasoning for proposed changes, and intervene for strategic guidance, complex problem-solving, or to adjust higher-level constraints, maintaining essential human control over the ultimate design direction.
              </div>
            </li>
          </ul>
        ...
        <div className="section-card p-6 rounded-2xl mt-12">
          ...
          <ul className="list-none pl-0 space-y-6 !my-6">
            ...
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              ...
              <div><strong className="text-primary block mb-1">Defect Detection:</strong> A <strong>Defect Detection Agent</strong>, utilizing <strong>AI-powered visual inspection systems</strong> and advanced computer vision algorithms, analyzes high-resolution wafer scans and in-line process monitoring data. It identifies, classifies, and localizes <strong>microscopic physical defects</strong> (e.g., shorts, opens, particles) with a speed and accuracy far exceeding traditional human capabilities or simpler automated optical inspection systems. This dramatically accelerates <strong>quality control and root cause analysis</strong> in the fab.</div>
            </li>
            <li className="flex items-start p-3 border border-slate-700 rounded-lg bg-slate-800/30 w-full">
              <CheckCircle2 className="h-6 w-6 text-primary mr-3 mt-1 flex-shrink-0" />
              <div><strong className="text-primary block mb-1">Post-Silicon Validation:</strong> A <strong>Post-Silicon Validation Agent</strong> automates the complex <strong>bring-up and characterization process</strong> for prototype chips and first silicon. It dynamically orchestrates lab equipment, runs comprehensive diagnostics, collects <strong>detailed performance data</strong> from the actual silicon (e.g., power consumption under various workloads, maximum operating frequency, signal integrity), and automatically correlates any discrepancies against the meticulously documented <strong>pre-silicon simulation results and PPA targets</strong>. This creates a final, invaluable <strong>feedback loop</strong> directly into our <strong>Knowledge Graph Agent</strong>, continuously refining our verification models, simulation methodologies, and predictive AI models for all future chip design projects. This ensures continuous learning and improvement in our design and manufacturing processes.</div>
            </li>
          </ul>
        </div>
        {/* Stage 3.11 END */}
