      ...
      <main className="container mx-auto px-6">
        ...
        <div className="text-center mt-[-4rem] mb-16">
          <Link href="/strategic-imperative" passHref>
            <Button variant="outline" size="lg" className="bg-transparent text-yellow-400 border-yellow-500 hover:bg-yellow-500/20 hover:text-yellow-300 hover:border-yellow-400 transition-all duration-300 ease-in-out transform hover:scale-105">
        ...
        <div className="text-center mt-8 mb-16">
           <Link href="/roadmap-details" passHref>
            <Button variant="outline" size="lg" className="bg-transparent text-lime-400 border-lime-500 hover:bg-lime-500/20 hover:text-lime-300 hover:border-lime-400 transition-all duration-300 ease-in-out transform hover:scale-105">
