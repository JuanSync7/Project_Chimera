        ...
        <div className="md:col-span-2">
           <SectionCard
            ...
            <ul class='list-disc list-inside mt-3 space-y-2 text-slate-400 text-left max-w-2xl mx-auto'>
              <li><strong class="text-fuchsia-400 font-semibold">CI/CD for LLM Applications:</strong> Automated CI/CD pipelines test agent changes against <strong>hardware-specific 'golden datasets'</strong>, blocking regressions in design correctness, factual grounding, and tool-use accuracy.</li>
              <li><strong class="text-fuchsia-400 font-semibold">Evaluation-Driven Development:</strong> Drives continuous improvement by evaluating agents against <strong>critical hardware performance metrics</strong>, with domain experts defining test criteria and specialized AI agents <strong>probing design agents for weaknesses</strong>.</li>
              <li><strong class="text-fuchsia-400 font-semibold">LangSmith for Observability & Debugging:</strong> LangSmith provides <strong>end-to-end tracing</strong> for deep debuggability, transforming AI into an understandable system. Its integrated <strong>evaluation suite</strong> (for A/B testing and metric tracking) and robust <strong>human feedback mechanisms</strong> (like annotation queues for expert review) ensure continuous agent improvement.</li>
            </ul>`}
