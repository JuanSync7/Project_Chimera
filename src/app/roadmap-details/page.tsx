    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-6 py-12 pt-24 md:pt-32">
        ...
        <article className="prose prose-slate dark:prose-invert lg:prose-xl max-w-none text-slate-300 space-y-6">
          ...
          <p><strong>Core Technologies to Deploy:</strong> MCP Server v1.0, LangGraph, LangSmith, RAG Knowledge Base, RTL TDD Agent.</p>
          <p><strong>People &amp; Culture Focus:</strong> Identify early adopters; Form a core AI platform team.</p>
          <p><strong>Success Metrics:</strong> Successful deployment of the pilot agentic workflow; achievement of a &gt;95% functional test pass rate for the AI-generated RTL; a measurable reduction in design and verification time for the pilot IP block compared to human-only baseline; Infrastructure stability.</p>
          ...
          <p><strong>Core Technologies to Deploy:</strong> PPA Optimization Agent (RL), AIvril Verification Agent, CI/CD for Agents.</p>
          <p><strong>People &amp; Culture Focus:</strong> Launch "Agent Academy"; Train all engineers in AI tools &amp; methodologies; Foster custom agent development.</p>
          ...
          <p><strong>Core Technologies to Deploy:</strong> Hierarchical Supervisor Architecture; End-to-end integrated workflow; Emergent insight analysis capabilities.</p>
          <p><strong>People &amp; Culture Focus:</strong> Shift engineers from agent users to agent orchestrators; Solidify AI-first design culture throughout the organization.</p>
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-2xl font-medium text-sky-400">Phase 1: Crawl</h3>
              <p><strong>Timeline:</strong> Q3 2025 - Q4 2026</p>
              <p><strong>Key Objectives:</strong> Build foundational infrastructure; Prove viability with a pilot project.</p>
              <p><strong>Core Technologies to Deploy:</strong> MCP Server v1.0, LangGraph, LangSmith, RAG Knowledge Base, RTL TDD Agent.</p>
              <p><strong>People &amp; Culture Focus:</strong> Identify early adopters; Form a core AI platform team.</p>
              <p><strong>Key Success Metrics/KPIs:</strong> Pilot project success; Infrastructure stability; &gt;95% RTL test pass rate.</p>
            </div>
            <div>
              <h3 className="text-2xl font-medium text-purple-400">Phase 2: Walk</h3>
              <p><strong>Timeline:</strong> Q1 2027 - Q4 2028</p>
              <p><strong>Key Objectives:</strong> Scale agentic workflows; Drive cultural adoption and training.</p>
              <p><strong>Core Technologies to Deploy:</strong> PPA Optimization Agent (RL), AIvril Verification Agent, CI/CD for Agents.</p>
              <p><strong>People &amp; Culture Focus:</strong> Launch "Agent Academy"; Train all engineers; Foster custom agent development.</p>
              <p><strong>Key Success Metrics/KPIs:</strong> &gt;15% PPA improvement; &gt;50% verification time reduction; 80% of engineers trained.</p>
            </div>
            <div>
              <h3 className="text-2xl font-medium text-fuchsia-400">Phase 3: Run</h3>
              <p><strong>Timeline:</strong> Q1 2029 - Q4 2030</p>
              <p><strong>Key Objectives:</strong> Achieve full-stack autonomy; Leverage system for market dominance.</p>
              <p><strong>Core Technologies to Deploy:</strong> Hierarchical Supervisor; End-to-end integrated workflow; Emergent insight analysis.</p>
              <p><strong>People &amp; Culture Focus:</strong> Shift from agent users to agent orchestrators; AI-first design culture.</p>
              <p><strong>Key Success Metrics/KPIs:</strong> &gt;30% end-to-end cycle time reduction; Market leadership in PPA; First AI-designed chip tape-out.</p>
            </div>
          </div>
